...
import com.netvlops.nv.Detail.Detail;
import com.netvlops.nv.R;
import com.netvlops.nv.RPL;
...
public class AdapterListRPL extends RecyclerView.Adapter<AdapterListRPL.ViewHolder>{

    Context context;
    ArrayList<HashMap<String, String>> list_data;

    public AdapterListRPL(RPL rpl, ArrayList<HashMap<String, String>> list_data) {
        this.context = rpl;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(url_img + list_data.get(position).get("img_rpl"))
                .crossFade()
                .placeholder(R.mipmap.ic_launcher)
                .into(holder.imgSiswa);
        holder.tvSiswa.setText(list_data.get(position).get("nama_rpl"));
        holder.card.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent a = new Intent(view.getContext(), Detail.class);
                a.putExtra("nama_rpl", listItem.get("nama_rpl"));
                a.putExtra("desc_rpl", listItem.get("desc_rpl"));
                a.putExtra("img_rpl", listItem.get("img_rpl"));
